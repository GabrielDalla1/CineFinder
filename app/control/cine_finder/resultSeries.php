...
class resultSeries extends TPage
{
    protected $form;
    private $formFields = [];
    ...
    private static $formName = 'form_resultSeries';
    ...
    if (isset($innerArray['tv shows']) && is_array($innerArray['tv shows'])) {
        foreach ($innerArray['tv shows'] as $movie) {
        ...
        $response1 = $client->request('GET', "https://api.themoviedb.org/3/search/tv?query=$txt1&include_adult=false&language=pt-BR&page=1", [
        'headers' => [
        ...
        $response2 = $client->request('GET', "https://api.themoviedb.org/3/search/tv?query=$txt2&include_adult=false&language=pt-BR&page=1", [
        'headers' => [
        'Authorization' => 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJlMDg3YjhkNjlkODdlMTAzYTU0NjJjODVjZWZiOGExMiIsInN1YiI6IjY0ZTQwMDI4MWZlYWMxMDBmZTVhNWM1OCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.y3_AcZ3DUYoJa4X_ijK3NE8gzmBz5TBKBGPm8bTwDIQ',
        'accept' => 'application/json',
        ],
        ...
        $response3 = $client->request('GET', "https://api.themoviedb.org/3/search/tv?query=$txt3&include_adult=false&language=pt-BR&page=1", [
        'headers' => [
        'Authorization' => 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJlMDg3YjhkNjlkODdlMTAzYTU0NjJjODVjZWZiOGExMiIsInN1YiI6IjY0ZTQwMDI4MWZlYWMxMDBmZTVhNWM1OCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.y3_AcZ3DUYoJa4X_ijK3NE8gzmBz5TBKBGPm8bTwDIQ',
        'accept' => 'application/json',
           ],
        ...
        $response4 = $client->request('GET', "https://api.themoviedb.org/3/search/tv?query=$txt4&include_adult=false&language=pt-BR&page=1", [
        'headers' => [
        'Authorization' => 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJlMDg3YjhkNjlkODdlMTAzYTU0NjJjODVjZWZiOGExMiIsInN1YiI6IjY0ZTQwMDI4MWZlYWMxMDBmZTVhNWM1OCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.y3_AcZ3DUYoJa4X_ijK3NE8gzmBz5TBKBGPm8bTwDIQ',
        'accept' => 'application/json',
           ],
         ...
         $response5 = $client->request('GET', "https://api.themoviedb.org/3/search/tv?query=$txt5&include_adult=false&language=pt-BR&page=1", [
        'headers' => [
        'Authorization' => 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJlMDg3YjhkNjlkODdlMTAzYTU0NjJjODVjZWZiOGExMiIsInN1YiI6IjY0ZTQwMDI4MWZlYWMxMDBmZTVhNWM1OCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.y3_AcZ3DUYoJa4X_ijK3NE8gzmBz5TBKBGPm8bTwDIQ',
        'accept' => 'application/json',
           ],
         ...
         $response6 = $client->request('GET', "https://api.themoviedb.org/3/search/tv?query=$txt6&include_adult=false&language=pt-BR&page=1", [
        'headers' => [
        'Authorization' => 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJlMDg3YjhkNjlkODdlMTAzYTU0NjJjODVjZWZiOGExMiIsInN1YiI6IjY0ZTQwMDI4MWZlYWMxMDBmZTVhNWM1OCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.y3_AcZ3DUYoJa4X_ijK3NE8gzmBz5TBKBGPm8bTwDIQ',
        'accept' => 'application/json',
           ],
        ...
        $response7 = $client->request('GET', "https://api.themoviedb.org/3/search/tv?query=$txt7&include_adult=false&language=pt-BR&page=1", [
        'headers' => [
        'Authorization' => 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJlMDg3YjhkNjlkODdlMTAzYTU0NjJjODVjZWZiOGExMiIsInN1YiI6IjY0ZTQwMDI4MWZlYWMxMDBmZTVhNWM1OCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.y3_AcZ3DUYoJa4X_ijK3NE8gzmBz5TBKBGPm8bTwDIQ',
        'accept' => 'application/json',
           ],
       ...
       $response8 = $client->request('GET', "https://api.themoviedb.org/3/search/tv?query=$txt8&include_adult=false&language=pt-BR&page=1", [
        'headers' => [
        'Authorization' => 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJlMDg3YjhkNjlkODdlMTAzYTU0NjJjODVjZWZiOGExMiIsInN1YiI6IjY0ZTQwMDI4MWZlYWMxMDBmZTVhNWM1OCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.y3_AcZ3DUYoJa4X_ijK3NE8gzmBz5TBKBGPm8bTwDIQ',
        'accept' => 'application/json',
           ],
      ...
      $txt1Title = $data1['results'][0]['name'];
      $txt1release_date = $data1['results'][0]['first_air_date'];
      $txt1Overview = $data1['results'][0]['overview'];

      $txt2Poster_path = $data2['results'][0]['poster_path'];
      $txt2Title = $data2['results'][0]['name'];
      $txt2release_date = $data2['results'][0]['first_air_date'];
      $txt2Overview = $data2['results'][0]['overview'];

      $txt3Poster_path = $data3['results'][0]['poster_path'];
      $txt3Title = $data3['results'][0]['name'];
      $txt3release_date = $data3['results'][0]['first_air_date'];
      $txt3Overview = $data3['results'][0]['overview'];

      $txt4Poster_path = $data4['results'][0]['poster_path'];
      $txt4Title = $data4['results'][0]['name'];
      $txt4release_date = $data4['results'][0]['first_air_date'];
      $txt4Overview = $data4['results'][0]['overview'];

      $txt5Poster_path = $data5['results'][0]['poster_path'];
      $txt5Title = $data5['results'][0]['name'];
      $txt5release_date = $data5['results'][0]['first_air_date'];
      $txt5Overview = $data5['results'][0]['overview'];

      $txt6Poster_path = $data6['results'][0]['poster_path'];
      $txt6Title = $data6['results'][0]['name'];
      $txt6release_date = $data6['results'][0]['first_air_date'];
      $txt6Overview = $data6['results'][0]['overview'];

      $txt7Poster_path = $data7['results'][0]['poster_path'];
      $txt7Title = $data7['results'][0]['name'];
      $txt7release_date = $data7['results'][0]['first_air_date'];
      $txt7Overview = $data7['results'][0]['overview'];

      $txt8Poster_path = $data8['results'][0]['poster_path'];
      $txt8Title = $data8['results'][0]['name'];
      $txt8release_date = $data8['results'][0]['first_air_date'];
    ...
    if(isset($chat)){
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Cine Finder","Resultado Série"]));
        }
